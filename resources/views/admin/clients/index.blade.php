        ...
        <div class="col-12">
            <div class="card">
                <div style="padding: 20px">
                    ...
                    <a href="{{ route('admin.clients.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Create</a>

                    <form method="post" action="{{ route('admin.clients.bulk_delete') }}" style="display: inline-block;">
                        @csrf
                        @method('delete')
